...
class ArtisanModifyRequest extends FormRequest
{
    /**
    ...
    {
        return ([
                'required' => 'le champ :attribute est ',
                'date' => 'la valeur de :attribute doit être une date valide',
                'string' => 'la valeur de :attribute doit être un chaine de charatère',
                'max' => 'la taille  de :attribute ne doit pas depasser :max charatères',
