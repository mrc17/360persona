        ...
        <div class=" py-4 h-screen md:block  mx-auto px-3 rounded-md  relative overflow-x-auto transition-transform duration-300 ease-in-out">
            ...
            <form method="POST" action="{{ route('create-artisan') }}" class="bg-white p-5 rounded-lg ">
                ...
                <div class="mt-6 flex items-center justify-end gap-x-6">
                    <button type="button" button data-modal-target="popup-modal" data-modal-toggle="popup-modal" class="rounded-md bg-white px-3 py-2 text-sm font-semibold border-1 text-red-600 shadow-2xl hover:bg-red-600 hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 duration-150 ease-in-out focus-visible:outline-indigo-600">Suppression</button>
                    <a href="{{ route('show-modify-artisan',['artisan'=>$artisan->id]) }}" class="rounded-md bg-gray-600 px-3 py-2 text-sm font-semibold border-1 text-white shadow-2xl hover:bg-orange-600 hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 duration-150 ease-in-out focus-visible:outline-indigo-600">Modifier</a>
                </div>
                    ...
                    <div class="relative w-full max-w-md max-h-full">
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="p-6 text-center">
                                ...
                                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Êtes-vous sûr de vouloir supprimer l'artisan ?</h3>
                                <a href="{{ route('delete-artisan',['artisan'=>$artisan->id]) }}" data-modal-hide="popup-modal" type="button" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                    Oui, je suis sûr
                                </a>
