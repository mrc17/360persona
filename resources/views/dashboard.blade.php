                    ...
                    <div id="content" class="bg-white/10 col-span-12 rounded-lg p-6">
                        <div id="24h">
                            ...
                            <div id="stats" class="grid gird-cols-12 ">
                                ...
                                <p class="text-indigo-300 text-sm font-medium uppercase py-5 leading-4">LISTE DES ARTISANS ENREGISTRER AUJOURDHUI.</p>
                                <div class="relative pb-8 overflow-x-auto">
                                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                        <thead class="text-xs text-gray-700 uppercase bg-gray-100 dark:bg-gray-700 dark:text-gray-400">
                                            <tr>
                                        ...
                                        <tbody>
                                            @if (count($listedesArtisanenregistreparjour)==0)
                                            <tr class="bg-white dark:bg-gray-800">
                                                <td colspan="4" class="px-6 py-4 font-medium text-center text-gray-900 whitespace-nowrap dark:text-white">
                                                    Aucun artisan enregistré aujourd'hui
                                                </td>
                                            </tr>
                                            @else
                                            @foreach ($listedesArtisanenregistreparjour as $key => $Artisan )
                                            <tr class="bg-white dark:bg-gray-800">
                                                <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                    {{$rank = $key + 1}}
                                                </th>
                            ...
                            <div id="stats" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                                ...
                                <div class="bg-black/60 to-white/5 rounded-lg">
                                    <div class="flex flex-row items-center">
                                        ...
                                        <div class="p-2">
                                            <p class="text-xl font-bold">{{ $nombredesArtisanenregistreparjour }}</p>
                                            <p class="text-gray-500 font-medium">Nombre des artisans enregistrés aujourd'hui.</p>
