    ...
    <div id="view" class="h-auto w-screen dark:bg-gray-900 flex flex-row" x-data="{ sidenav: true }">
        ...
        <div class=" py-4 h-screen md:block  mx-auto px-3 rounded-md  relative overflow-x-auto transition-transform duration-300 ease-in-out">
            ...
            <div class="flex items-center p-4 mb-4 text-sm text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400" role="alert">
                ...
                <div>
                    <span class="font-medium">Succè alert!</span> {{session('success')}}.
                </div>
            </div>
            @endif
            <form method="POST" action="{{ route('modifyartisan') }}" class="bg-white dark:bg-gray-900 p-5 rounded-lg ">
                @csrf
                <div class="flex flex-col items-center border-2 p-2 border-black dark:border-white">
                    ...
                    <div class="flex flex-row flex-wrap mt-4">
                        ...
                        <input readonly type="date" value="{{ $artisan->fiche->date_fiche }}" class="rounded-tl-md rounded-bl-md px-2 py-3 text-sm text-gray-600 focus:outline-none" name="dateRecensement">
                        <p class="mx-2 py-4 dark:text-white font-bold">FICHE N°:</p>
                        <input readonly type="number" class="rounded-tl-md rounded-bl-md px-2 py-3 text-sm text-gray-600 focus:outline-none" name="ficheRecensement" value="{{ $artisan->fiche->num_fiche }}">
                        <p class="mx-2 py-4 dark:text-white font-bold">Code : KS- </p>
                        <input readonly type="text" class="rounded-tl-md rounded-bl-md px-2 py-3 text-sm text-gray-600 focus:outline-none" readonly value="{{ $artisan->fiche->code_fiche }}" name="codeRecensement" min="03" placeholder="" value="2023-05" /><span class="py-4"></span>
                    </div>
                    @if($errors->any())
                ...
                <div class="grid md:grid-cols-3 mt-5 md:gap-6">
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="text" name="ZoneRecenseur" value="{{ $artisan->fiche->zone_fiche }}" id="Zone" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                ...
                <div class="grid md:grid-cols-3 mt-5 md:gap-6">
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="text" name="AnneeExperienceProfessionnelleArtisan" value="{{ $artisan->an_exp_prof }}" id="An_exp_prof" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                    ...
                    <div class="grid md:grid-cols-2 md:gap-6">
                        ...
                        <div class="flex items-center w-1/2 gap-x-3">
                            <input id="Homme" name="sexeartisan" value="Homme" checked type="radio" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600">
                    ...
                    <div class="grid md:grid-cols-2 md:gap-6">
                        <div class="flex items-center w-1/2  gap-x-3">
                            <input id="Femme" checked type="radio" value="Femme" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600">
                            <label for="Femme" class="block text-sm font-medium leading-6 dark:text-white text-gray-900">Femme</label>
                        </div>
                        <div class="flex items-center w-1/2 gap-x-3">
                ...
                <div class="grid md:grid-cols-8 md:gap-6">
                    ...
                    @if ($artisan->habitation->regime_matrimonial =='Communauté de bien')
                    <div class="flex items-center col-span-2 mt-4 gap-x-3">
                        <input id="Regime" checked name="Regime" value="Communauté de bien" type="radio" class="h-4 w-4 dark:text-white border-gray-300 text-indigo-600 focus:ring-indigo-600">
                    ...
                    @elseif ($artisan->habitation->regime_matrimonial =='Séparation de bien')
                    <div class="flex items-center col-span-2 mt-4 gap-x-3">
                ...
                <div class="grid md:grid-cols-6 mt-5 md:gap-6">
                    ...
                    <div class="flex items-center gap-x-3">
                        <input id="CNPS" name="Assurance" value="CNPS" checked type="radio" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600">
                        <label for="CNPS" class="block text-sm font-medium dark:text-white leading-6 text-gray-900">CNPS</label>
                    </div>
                    <div class="flex items-center gap-x-3">
                        <input id="AUTREASSURANCE" name="Assurance" value="{{ $artisan->habitation->assurance->nom_organisation }}" type="radio" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600">
                ...
                <div class="grid md:grid-cols-8 mt-5 md:gap-6">
                    ...
                    @if ($artisan->habitation->organisation->etat_organisation=="Non")
                    <div class="flex items-center gap-x-3">
                    ...
                    <div class="flex items-center gap-x-3">
                        <input id="Non" name="etatFinance" checked value="Non" type="radio" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600">
                        <label for="Non" class="block text-sm font-medium leading-6 text-gray-900 dark:text-white">Non</label>
                    </div>
                    @elseif($artisan->habitation->organisation->etat_organisation=="Oui")
                    <div class="flex items-center gap-x-3">
                        <input id="Oui" name="etatFinance" value="Oui" checked type="radio" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600">
                        <label for="Oui" class="block text-sm font-medium leading-6 text-gray-900 dark:text-white">Oui</label>
                    </div>
                    <div class="flex items-center gap-x-3">
                ...
                <div class="grid md:grid-cols-8 mt-5 md:gap-6">
                    ...
                    @if ($artisan->habitation->organisation->etat_organisation=="Oui")
                    <div class="flex items-center gap-x-3">
                        ...
                        <label for="reponseorganitionoui" class="block text-sm font-medium dark:text-white text-gray-900 leading-6 text-gray-900">Oui</label>
                    </div>
                    <div class="flex items-center gap-x-3">
                        ...
                        <label for="reponseorganitionNon" class="block text-sm font-medium leading-6 dark:text-white text-gray-900 text-gray-900">Non</label>
                    </div>
                    @elseif ($artisan->habitation->organisation->etat_organisation=="Non")
                    <div class="flex items-center gap-x-3">
                ...
                <div class="grid md:grid-cols-2 mt-5 md:gap-6">
                    ...
                    <div class="relative  z-0 w-full mb-6 group">
                        <input type="text" name="CoutEstimatifEnChiffre" value="{{ $artisan->habitation->activite->cout_estimatif_en_chiffre }}" id="CoutestimatifEnchiffre" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                    ...
                    <div class="relative  z-0 w-full mb-6 group">
                        <input type="text" name="CoutEstimatifEnLettre" value="{{ $artisan->habitation->activite->cout_estimatif_en_lettre}}" id="Agent" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                ...
                <div class="grid md:grid-cols-3 mt-5 md:gap-6">
                    ...
                    <div class="grid md:grid-cols-3 mt-2 md:gap-6">
                        ...
                        @if ($artisan->parrain->sexe_parrain=="Homme")
                        <div class="flex items-center gap-x-3">
                        ...
                        @elseif ($artisan->parrain->sexe_parrain=="Femme")
                        <div class="flex items-center gap-x-3">
            ...
            <div class="relative w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Êtes-vous sûr de vouloir modifier les informations l'artisan ?</h3>
