...
<body class="font-poppins w-full antialiased ">
                    ...
                    <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                        <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                            <div id="pdf" class="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                                <p class="text-indigo-300 text-center text-sm font-medium uppercase py-5 leading-4">Liste des artisans rechercher en fonctions des  {{ implode(',',$columns) }} .</p>
    ...
    <script>
        ...
        function getColonnes(tag) {
            ...
            // Obtenez l'URL de base dynamiquement
            let baseUrl = window.location.origin;

            axios.get(baseUrl + '/getColonnes/' + valeur)
        ...
        function check(checkbox) {
            ...
            if (checkbox.checked) {
                ...
                lignesDonnees.forEach(function(ligne) {
                    ...
                    }else if (checkbox.value === "activite1") {
                        label.textContent = artisans[ligne.rowIndex - 1]['habitation'][''];
                    }
